  ...
  singletons: {
    ...
    homePage: singleton({
      ...
      schema: {
        ...
        adventuresEyebrow: fields.text({ label: 'Adventures Preview — Eyebrow' }),
        adventuresTitle:   fields.text({ label: 'Adventures Preview — Title' }),
        adventuresSub:     fields.text({ label: 'Adventures Preview — Subtitle' }),
        adventuresLink:    fields.text({ label: 'Adventures Preview — Link Text' }),
        elopementsEyebrow: fields.text({ label: 'Elopements Preview — Eyebrow' }),
        elopementsTitle:   fields.text({ label: 'Elopements Preview — Title' }),
        elopementsSub:     fields.text({ label: 'Elopements Preview — Subtitle' }),
        elopementsLink:    fields.text({ label: 'Elopements Preview — Link Text' }),
        ctaEyebrow:        fields.text({ label: 'CTA Eyebrow' }),
        ctaTitle:          fields.text({ label: 'CTA Title', multiline: true }),
        ctaSub:            fields.text({ label: 'CTA Subtitle' }),
        ctaButton:         fields.text({ label: 'CTA Button Text' }),
      },
    }),
    ...
    contactPage: singleton({
      ...
      schema: {
        ...
        formDateLabel:    fields.text({ label: 'Date Field Label' }),
        formLocationLabel: fields.text({ label: 'Location Field Label' }),
        formReferralLabel: fields.text({ label: 'Referral Field Label' }),
        formMessageLabel:  fields.text({ label: 'Message Field Label' }),
        formSubmitButton:  fields.text({ label: 'Submit Button Text' }),
      },
    }),
  ...
  collections: {
    ...
    adventures: collection({
      ...
      schema: {
        ...
        signature: fields.text({ label: 'Post Signature (default: — Michael)' }),
      },
    }),
